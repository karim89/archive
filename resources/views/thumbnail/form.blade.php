<div class="modal-header">
    ...
    <h2 class="modal-title" id="myModalLabel">Form Thumbnail</h2>
</div>
<div class="modal-body">
	@if(isset($thumbnail))
		{!! Form::model($thumbnail, array('url'=> URL::to('thumbnail/update/'.$thumbnail->id), 'class'=>'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
	@else
		{!! Form::open(array('url' => 'thumbnail/store', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
	@endif
	<div class="row">
        <div class="form-group  col-md-12 ">
            ...
            <div class="col-md-8">
                @if(isset($thumbnail))
                    @if($thumbnail->path)
                        <img src='{{$thumbnail->path }}' class="col-md-12 img-thumbnail">
        ...
        <div class="form-group col-md-12 ">
            ...
            <div class="col-md-8">
                <button type="submit" name="save" class="btn btn-primary pull-right btn-sm" value="save">{{isset($thumbnail) ? "Update" : "Save"}}</button>
            </div>
        </div>
    </div>
</div>
