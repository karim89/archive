<div class="modal-header">
    ...
    <h2 class="modal-title" id="myModalLabel">Form Status</h2>
</div>
<div class="modal-body">
	@if(isset($status))
		{!! Form::model($status, array('url'=> URL::to('status/update/'.$status->id), 'class'=>'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
	@else
		{!! Form::open(array('url' => 'status/store', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
	@endif
	<div class="row">
        ...
        <div class="form-group col-md-12 ">
            ...
            <div class="col-md-8">
                <button type="submit" name="save" class="btn btn-primary pull-right btn-sm" value="save">{{isset($status) ? "Update" : "Save"}}</button>
            </div>
        </div>
    </div>
</div>
