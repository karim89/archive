<div class="modal-header">
    ...
    <h2 class="modal-title" id="myModalLabel">Form Gender</h2>
</div>
<div class="modal-body">
    @if(isset($gender))
        {!! Form::model($gender, array('url'=> URL::to('gender/update/'.$gender->id), 'class'=>'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
    @else
        {!! Form::open(array('url' => 'gender/store', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
    @endif
    <div class="row">
        ...
        <div class="form-group col-md-12 ">
            ...
            <div class="col-md-8">
                <button type="submit" name="save" class="btn btn-primary pull-right btn-sm" value="save">{{isset($gender) ? "Update" : "Save"}}</button>
            </div>
        </div>
    </div>
</div>
