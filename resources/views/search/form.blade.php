<div class="modal-header">
    ...
    <h2 class="modal-title" id="myModalLabel">Form Search</h2>
</div>
<div class="modal-body">
	@if(isset($search))
		{!! Form::model($search, array('url'=> URL::to('search/update/'.$search->id), 'class'=>'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
	@else
		{!! Form::open(array('url' => 'search/store', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
	@endif
	<div class="row">
        ...
        <div class="form-group col-md-12 ">
            ...
            <div class="col-md-8">
                <button type="submit" name="save" class="btn btn-primary pull-right btn-sm" value="save">{{isset($search) ? "Update" : "Save"}}</button>
            </div>
        </div>
    </div>
</div>
